...
public class GlobalExceptionHandler {
        ...
        /**
         * Handle static resource not found (like favicon.ico)
         * This prevents spam logs for common browser requests
         */
        ...
        public ResponseEntity<ErrorResponse> handleNoResourceFound(
                ...
                if (path.contains("favicon.ico")) {
                        log.debug("🔍 Favicon request - browser automatically requests this: {}", path);
                        return ResponseEntity.status(HttpStatus.NOT_FOUND).build();
                }

                // Log other missing static resources as warnings (not errors)
                log.warn("⚠️ Static resource not found: {}", path);
        ...
        public ResponseEntity<ErrorResponse> handleGenericException(
                ...
                // Don't spam logs with favicon errors - handle them quietly
                if (path.contains("favicon.ico")) {
                        log.debug("🔍 Favicon request handled: {}", path);
                        return ResponseEntity.status(HttpStatus.NOT_FOUND).build();
                }
